# ApoRaviz Tools Progress

## Current Role

`ApoRaviz_Tools` is the workspace repository for small runnable tools.

## Done

- [x] Create root repository structure
- [x] Add `split-order-txt` as the first CLI tool
...
- [x] Preserve export separator and trailer rows in every output file
